...
public class JspUtil {
    ...
    public static void main(String[] args) {
        try {
            Context context = new Context("/javaweb", "/Users/alexchen/programs/diytomcat/javaweb/web", null, true);
            File file = new File("/Users/alexchen/programs/diytomcat/javaweb/web/index.jsp");
    ...
    public static void compileJsp(Context context, File file) throws JasperException {
        ...
        String workPath = new File(Constants.workFolder, subFolder).getAbsolutePath() + File.separator;
    ...
    public static String getServletPath(String uri, String subFolder) {
        ...
        File tempFile = FileUtil.file(Constants.workFolder, subFolder, tempPath);
    ...
    public static String getJspServletClassName(String uri, String subFolder) {
        File tempFile = FileUtil.file(Constants.workFolder, subFolder);
